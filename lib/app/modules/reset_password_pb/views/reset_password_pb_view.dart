...
class ResetPasswordPbView extends GetView<ResetPasswordPbController> {
  const ResetPasswordPbView({super.key});
  @override
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 18),
            Text(
              "Untuk mendapatkan kode\nverifikasi masukan email dahulu",
            ...
            Button(
              ...
              nama: "Selanjutnya",
              fungsi: () {
                Get.toNamed(Routes.RESET_PASSWORD_C);
              },
            ),
          ],
        ),
